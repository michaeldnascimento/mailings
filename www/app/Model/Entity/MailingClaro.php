...
use \PDO;
use PDOStatement;
use \App\Model\Entity\Property\Claro as ClassClaro;

class MailingClaro extends ClassClaro {
    ...
    public function cadastrar():bool
    {
        ...
        $this->id = (new Database('db_mailings', 'mailing_claro'))->insert([
    ...
    public function atualizar(): bool
    {
        ...
        return (new Database('db_mailings', 'mailing_claro'))->update('id = '. $this->id, [
            'nome_cliente' => $this->nome_cliente,
            'fone1' => $this->fone1,
            'fone2' => $this->fone2,
            'endereco' => $this->endereco,
    ...
    public static function setStatusMailingById(int $id_mailing, int $status_lista): bool
    {
        ...
        return (new Database('db_mailings', 'mailing_claro'))->update('id_mailing = '.$id_mailing, [
