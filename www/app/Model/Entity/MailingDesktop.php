...
class MailingDesktop extends ClassDesktop {
    ...
    public function cadastrar():bool
    {
        ...
        $this->id = (new Database('db_mailings', 'mailing_desktop'))->insert([
            'ordens' => $this->ordens,
    ...
    {
        return (new Database('db_mailings', 'mailing_desktop'))->select($fields, $join, $where, $order, $group, $limit);
    }
