...
use \PDO;
use PDOStatement;
use \App\Model\Entity\Property\Americanet as ClassAmericanet;

class MailingAmericanet extends ClassAmericanet {
    ...
    public function cadastrar():bool
    {
        ...
        $this->id = (new Database('db_mailings', 'mailing_americanet'))->insert([
    ...
    public function atualizar(): bool
    {
        ...
        return (new Database('db_mailings', 'mailing_americanet'))->update('id = '. $this->id, [
            'cliente'  => $this->cliente,
            'id_cliente' => $this->id_cliente,
            'tipo_cliente' => $this->tipo_cliente,
            'cpf_cnpj' => $this->cpf_cnpj,
    ...
    public static function setStatusMailingById(int $id_mailing, int $status_lista): bool
    {
        ...
        return (new Database('db_mailings', 'mailing_americanet'))->update('id_mailing = '.$id_mailing, [
     ...
     *
     * @param string $list
     * @return ClassAmericanet|null
     */
    public static function getMailingQtd(string $list): ?ClassAmericanet
    {
        return self::getMailingAmericanet(
            'count(*) as qtd',
            '',
     ...
     * @return ClassAmericanet|null
     */
    public static function getMailingQtdUser(string $list, int $id_user): ?ClassAmericanet
    {
        return self::getMailingAmericanet(
            'count(*) as qtd',
            '',
     ...
     */
    public static function getMailingAmericanet(string $fields = null, string $join = null, string $where = null, string $order = null, string $group = null, string $limit = null): PDOStatement
    {
        return (new Database('db_mailings', 'mailing_americanet'))->select($fields, $join, $where, $order, $group, $limit);
    }
