...
use \PDO;
use PDOStatement;
use \App\Model\Entity\Property\Algar as ClassAlgar;

class MailingAlgar extends ClassAlgar {
    ...
    public function cadastrar():bool
    {
        ...
        $this->id = (new Database('db_mailings', 'mailing_algar'))->insert([
    ...
    public function atualizar(): bool
    {
        ...
        return (new Database('db_mailings', 'mailing_algar'))->update('id = '. $this->id, [
            'nome_cliente' => $this->nome_cliente,
            'fone1' => $this->fone1,
            'fone2' => $this->fone2,
            'endereco' => $this->endereco,
    ...
    public static function setStatusMailingById(int $id_mailing, int $status_lista): bool
    {
        ...
        return (new Database('db_mailings', 'mailing_algar'))->update('id_mailing = '.$id_mailing, [
